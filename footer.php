    ...
    <section class="s-extra">
                    ...
                    ?>
                        <article class="col-block popular__post">
                            ...
                            <section class="popular__meta">
                                ...
                                <span class="popular__date"><span><?php _e("on", "philosophy"); ?></span> <time datetime="<?php echo esc_html(get_the_date("Y-m-d")); ?>"><?php echo esc_html(get_the_date()); ?></time></span>
                            </section>
                        </article>
                    <?php
                    }
        ...
        <div class="row bottom tags-wrap">
            <div class="col-full tags">
                <?php
                    $philosophy_tags = get_tags();
                    if ($philosophy_tags) {
                ?>
                        <h3><?php _e("Tags", "philosophy"); ?></h3>
                        <div class="tagcloud">
                            <?php
                            foreach ($philosophy_tags as $tag) {
                                $philosophy_tag_name = esc_html($tag->name);
                                $philosophy_tag_url = esc_url(get_tag_link($tag->term_id));
                                echo "<a href='{$philosophy_tag_url}'>{$philosophy_tag_name}</a>";
                            }
                            ?>
