                    ...
                    <ul class="s-content__author-social">
                        ...
                        ?>
                            <?php if ($philosophy_facebook) : ?>
                                <li><a href="<?php echo esc_url($philosophy_facebook); ?>"><?php _e("Facebook","philosophy");?></a></li>
                            <?php endif; ?>
                            <?php if ($philosophy_twitter) : ?>
                                <li><a href="<?php echo esc_url($philosophy_twitter); ?>"><?php _e("Twitter","philosophy");?></a></li>
                            <?php endif; ?>
                            <?php if ($philosophy_instagram) : ?>
                                <li><a href="<?php echo esc_url($philosophy_instagram); ?>"><?php _e("Instagram","philosophy");?></a></li>
                        <?php endif;
                        endif; ?>
                    </ul>
                </div>
