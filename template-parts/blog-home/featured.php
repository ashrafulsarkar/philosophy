                    ...
                    <div class="entry" style="background-image:url('<?php echo esc_url($post_data[0]["thumbnail"]); ?>');">
                        ...
                        <div class="entry__content">
                            <span class="entry__category">
                                <a href="<?php echo esc_url($post_data[0]['catlink']); ?>">
                                    <?php echo esc_html($post_data[0]["cat"]); ?>
                                </a>
                            </span>

                            <h1>
                                <a href="<?php echo esc_url($post_data[0]['permalink']); ?>" title="<?php echo esc_attr($post_data[0]["title"]); ?>">
                ...
                <div class="featured__column featured__column--small">
                    ...
                    ?>
                        <div class="entry" style="background-image:url('<?php echo esc_url($post_data[$i]["thumbnail"]); ?>');">
                            ...
                            <div class="entry__content">
                                <span class="entry__category">
                                    <a href="<?php echo esc_url($post_data[$i]['catlink']); ?>">
                                        <?php echo esc_html($post_data[$i]["cat"]); ?>
                                    </a>
                                </span>

                                <h1>
                                    <a href="<?php echo esc_url($post_data[$i]['permalink']); ?>" title="<?php echo esc_attr($post_data[$i]["title"]); ?>"><?php echo esc_html($post_data[$i]["title"]); ?></a>
                                </h1>
